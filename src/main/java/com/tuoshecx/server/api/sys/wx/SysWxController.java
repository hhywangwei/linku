...
@Api(value = "/sys/wx", tags = "S-店铺微信小程序管理")
public class SysWxController {
    ...
    public ResultPageVo<SmallTemplate> queryMessageTemplate(@RequestParam(required = false) @ApiParam(value = "店铺编号") String shopId,
        ...
        List<ShopWxAuthorized> authorizeds = service.queryAuthorized(shopId);
    ...
    public ResultPageVo<SendMessage> querySendMessage(@RequestParam(required = false) @ApiParam("店铺编号") String shopId,
