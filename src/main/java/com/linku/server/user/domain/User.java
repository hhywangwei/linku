package com.linku.server.user.domain;
...
public class User {
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, shopId, appid, openid, unionid, username, password, name, nickname, phone, sex, headImg, province, city, country, updateTime, createTime);
    }
